    ...
    <GridContent>
      <>
        <Row gutter={24}>
          ...
          >
            <Card title="物联网实时状态" bordered={false}>
              <Row>
                ...
                <Col md={6} sm={12} xs={24}>
                  <Statistic title="实时在线用户" value="1003546" />
                </Col>
                <Col md={6} sm={12} xs={24}>
                  <Countdown title="平台升级倒计时" value={deadline} format="HH:mm:ss:SSS" />
                </Col>
                <Col md={6} sm={12} xs={24}>
                  <Statistic title="全国区域数" suffix="元" value={numeral(234).format('0,0')} />
                </Col>
              </Row>
        ...
        <Row gutter={24}>
          ...
          >
            <Card title="各类设备占比" bordered={false} className={styles.pieCard}>
              <Row
                style={{
                  padding: '16px 0',
                }}
          ...
          >
            ...
            >
               <Liquid
                ...
                padding={[0, 0, 0, 0]}
                statistic={{
                  formatter: (value) => `${((100 * 100) / 10000).toFixed(1)}%`,
                }}
              />
          ...
          >
            ...
            >
              <Liquid
                ...
                padding={[0, 0, 0, 0]}
                statistic={{
                  formatter: (value) => `${((100 * 9900) / 10000).toFixed(1)}%`,
                }}
              />
            </Card>
          </Col>
