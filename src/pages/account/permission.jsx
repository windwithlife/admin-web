...
import UpdateForm from './components/PermissionUpdateForm';
...
const handleAdd = async (fields) => {
  ...
  try {
    await AccountModel.addPermission({ ...fields });
    hide();
...
const handleUpdate = async (fields) => {
  ...
  try {
    await AccountModel.updatePermission({
   ...fields
    });
    hide();
...
const handleRemove = async (selectedRows) => {
  ...
  try {
    await AccountModel.removePermissions({
...
const handleRemoveRow = async (index) => {
  ...
  try {
    await AccountModel.removePermission({
      id: index,
    });
    hide();
    message.success('Deleted successfully and will refresh soon');
  ...
  return (
    <PageContainer>
      <ProTable
        ...
        request={AccountModel.queryAllPermissions}
        columns={columns}
        rowSelection={{
