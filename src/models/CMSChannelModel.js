...
export default class DefaultModel {
  ...
  static async update(params, options) {
    return await new Model().fetch_post('/common-service/category/udpate', params, options);
  }
  ...
  static async queryByParams(params, options) {
    return await new Model().raw_get('/common-service/category/queryAll', params, options);
  }
}
